...
<head>
  ...
  <title>Admin Panel-<?php echo $kullanicicek['kullanici_ad'] ?> <?php echo $kullanicicek['kullanici_soyad'] ?></title>
  <link rel="shortcut icon" type="image/x-icon" href="https://www.iconarchive.com/download/i99388/zhoolego/material/Control-Panel.ico">
      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          <div class="navbar nav_title" style="border: 0;">
            <a href="index.php" class="site_title"><i class="fa fa-shopping-basket"></i> <span>Heybe</span></a>
          </div>
